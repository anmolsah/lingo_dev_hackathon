  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4 font-['Inter',sans-serif]">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-[#137fec]/20 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-400/15 rounded-full blur-[100px]"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500">Sign in to continue to PolyConnect</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 text-[#137fec] border-slate-300 rounded focus:ring-[#137fec]" />
                <span className="text-sm text-slate-600">Remember me</span>
              </label>
              <a href="#" className="text-sm text-[#137fec] hover:underline">Forgot password?</a>
            </div>
          ...
          <p className="text-center text-slate-600 mt-6">
            ...
            <Link to="/signup" className="text-[#137fec] font-medium hover:underline">
              Sign up
            </Link>
          </p>
        </div>
